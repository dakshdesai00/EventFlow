    ...
    <div className="max-w-md mx-auto mt-16 bg-white p-6 rounded shadow">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="flex items-center justify-end">
          <button type="submit" className="px-4 py-2 bg-green-600 text-white rounded flex items-center gap-2" disabled={isSubmitting}>
            {isSubmitting ? <LoadingSpinner className="h-4 w-4" /> : 'Register'}
          </button>
        </div>
      </form>
    </div>

...
public interface SecretVariableRepo extends JpaRepository<SecretVariable, Long> {
    ...
    List<SecretVariable> findByFunctionId(Long functionId);
    
    Optional<SecretVariable> findByProjectIdAndKeyAndFunctionIsNull(Long projectId, String key);
    Optional<SecretVariable> findByFunctionIdAndKey(Long functionId, String key);
}
